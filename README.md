...
**Previously:**
- **Amaral Media** - 2021–2025: Founded at 16 during high school as a bootstrapped and solo-run digital media project, that became the largest in its niche • [Instagram](https://www.instagram.com/amaralmediasite/) ‣ Coverage: [RTP](https://www.rtp.pt/play/p6381/e695600/dois-dedos-de-conversa) • [Gerador](https://gerador.eu/amaral-media-por-um-mundo-melhor-atraves-da-educacao-e-literatura/) • [Uniarea](https://uniarea.com/um-passo-de-cada-vez-alcancando-objetivos-no-secundario/) • [Cultura](https://www.e-cultura.pt/artigo/30890)
- **NIIEM** 2023: Member of the media team and speaker at one of the events of *Núcleo de Investigação e Intervenção na Educação Emocional*.
- **Sophie Seromenho Clinic** - 2024–2025: Head of technology that built and managed the operations of the website, technology, e-commerce, and digital presence of the mental health clinic • [Web](https://sophieseromenho.pt)
- **NEFilUM** - 2025–2026: Elected President representing the student body of Philosophy at the University of Minho.
...
- **Art Curator MCP** (Fine-tuning).
- **Agent Coding Lab:** Your own Begginer-Friendly AI-Agentic Lab • [Repo](https://github.com/pedromanuelamaral/agent-lab) ‣ [Page](https://pedromanuelamaral.github.io/agent-lab/)
- **Model Card AI CV**: Interactive fun model-card style profile • [Repo](https://github.com/pedromanuelamaral/model-card)
- **My Fitness:** Hub for all my workouts and fitness • [Repo](https://github.com/pedromanuelamaral/my-fitness) ‣ [Page](https://pedromanuelamaral.github.io/my-fitness/)
- **Mentally Here:** Personal Mental Health Companion • [Repo](https://github.com/pedromanuelamaral/mentally-here)
- **Fusion Research:** Interactive Equity Research Report • [Repo](https://github.com/pedromanuelamaral/fusion-research) ‣ [Page](https://pedromanuelamaral.github.io/fusion-research/)
- **Study Buddy:** Study today something that you didn't know yesterday. (Fine-tuning).
- **Singularity** (Procrastinating).
- **Assist-OS** (Hackathon Project).
- **Semi-box** (Procrastinating).
- **Amaral Media Arq.**: Open-source media archive of mental health & literature. (Fine-tuning).
...
- My Public Notepad • [Check](https://github.com/pedromanuelamaral/notepad)
